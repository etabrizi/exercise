...
function (_Component) {
  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_1__["default"])(MainApp, [{
    ...
    value: function componentDidMount() {
      var last = props.work.exercises[props.work.exercises.length - 1];

      if (last) {} else this.props.work.exercises.forEach(function (item) {
    ...
    value: function render() {
      var app = this.state.step !== 'loading' ? __jsx("div", {
        __source: {
...
//# sourceMappingURL=index.js.4bc9a9de0c994dd005a3.hot-update.js.map