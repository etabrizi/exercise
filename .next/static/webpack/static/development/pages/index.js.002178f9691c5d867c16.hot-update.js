...
function (_Component) {
  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_1__["default"])(MainApp, [{
    ...
    value: function render() {
      var error = this.state.step !== 'error' ? '<p className="loading"></p>Sorry, the application is offline' : '';
      ...
      return __jsx(_container__WEBPACK_IMPORTED_MODULE_10__["default"], {
        ...
        __self: this
      }, this.state.step === 'start' && app, __jsx("p", {
        className: "loading",
        __source: {
          fileName: _jsxFileName,
          lineNumber: 184
...
//# sourceMappingURL=index.js.002178f9691c5d867c16.hot-update.js.map